    ...
    return (
      <div className="skills">
        ...
        <div className="title">
          <h3>Skills</h3>
          <p>
            Note: of course this kind of skills overview is biased. So I recommend paying more
            attention to the &quot;Most Experienced With&quot; and &quot;Some Experience With&quot;{' '}
            filters which sum up the skills I have spent more time working with in the past years.
          </p>
        </div>
